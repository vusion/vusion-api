...
export interface VusionConfig {
    ...
    babel: boolean,
    babelIncludes: Array<string>,
    webpack: Object,
    webpackDevServer: Object,
    postcss: Array<Object | string>,
    vue: Object,
    karma: Object,
    options: Object,
    configPath: string;
...
export default function getDefaults() {
    const defaults: VusionConfig = {
        ...
        resolvePriority: ResolvePriority.current,            // Priority to resolve modules or loaders, "current"(default), "cwd" or "cli"
