 ...
 * 从业务模板中添加模块
 */
export declare function addModule(options: MaterialOptions): Promise<void>;
/**
 * @deprecated
 * @param options
 */
export declare function removeModule(options: MaterialOptions): Promise<void>;
/**
 * @deprecated
 */
export declare function addLeafView(parent: vfs.View, name: string, title: string, ext?: string): Promise<string>;
/**
 * @deprecated
 */
export declare function addLeafViewFromBlock(source: MaterialSource, parent: vfs.View, name: string, title: string): Promise<string>;
export declare function addBranchView(parent: vfs.View, name: string, title: string, ext?: string): Promise<string>;
/**
 * @deprecated
 */
export declare function addBranchViewFromBlock(source: MaterialSource, parent: vfs.View, name: string, title: string): Promise<string>;
/**
 * @deprecated
 */
export declare function addBranchWrapper(parent: vfs.View, name: string, title: string): Promise<string>;
/**
 * @deprecated
 */
export declare function removeLeafView(view: vfs.View): Promise<void>;
/**
